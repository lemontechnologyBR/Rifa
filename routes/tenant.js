...
api.post('/pagamentos/sincronizar', requireOrganizador, apiController.sincronizarPagamentos);
...
admin.post('/login', authLimiter, organizadorController.login);
admin.get('/logout', organizadorController.logout);
admin.get('/esqueci-senha', organizadorController.esqueciSenhaForm);
