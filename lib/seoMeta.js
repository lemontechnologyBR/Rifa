...
const pctOrgWoovi = Math.round(ORGANIZADOR_PERCENTUAL_WOOVI * 100);

const TEXTO_COMISSAO = `Comissão de ${pctTaxaMp}% no Mercado Pago (organizador recebe ${pctOrgMp}%) ou ${pctTaxaWoovi}% no PIX via plataforma (organizador recebe ${pctOrgWoovi}%). O comprador paga o valor exato da cota, sem acréscimo.`;
...
function platformLandingMeta(appUrl) {
  ...
  return {
    ...
    seoDescription: truncate(
      `Plataforma grátis para criar rifas online. PIX automático, cotas ilimitadas e comissão de ${pctTaxaMp}% (Mercado Pago) ou ${pctTaxaWoovi}% (PIX plataforma). Comprador paga valor exato da cota.`
    ),
    ...
    seoJsonLd: {
      ...
      '@graph': [
        ...
        },
        {
          ...
          url,
          description: `Crie rifas online com PIX automático. Grátis para começar — comissão de ${pctTaxaMp}% a ${pctTaxaWoovi}% sobre vendas, sem mensalidade.`,
        ...
        },
        {
          ...
          offers: {
            ...
            price: '0',
            priceCurrency: 'BRL',
            description: `Gratuito para criar conta. Comissão de ${pctTaxaMp}% (MP) ou ${pctTaxaWoovi}% (PIX plataforma) sobre vendas`
          },
          featureList: [
            ...
            'Sem mensalidade',
            `Comissão ${pctTaxaMp}% Mercado Pago ou ${pctTaxaWoovi}% PIX plataforma`
          ]
        },
        faqJsonLd(faq)
      ]
...
function cadastroMeta(appUrl) {
  ...
  return {
    ...
    seoDescription: truncate(
      `Cadastre-se grátis e crie rifas online em minutos. PIX automático, comissão de ${pctTaxaMp}% (MP) ou ${pctTaxaWoovi}% (PIX plataforma). Comprador paga valor exato da cota.`
    ),
