...
function platformLandingMeta(appUrl) {
  ...
  return {
    ...
    seoDescription: truncate(
      `Plataforma grátis para criar rifas online. PIX automático via Woovi, cotas ilimitadas e comissão de ${taxaWooviLabel}. Comprador paga valor exato da cota.`
    ),
    ...
    seoJsonLd: {
      ...
      '@graph': [
        ...
        },
        {
          ...
          url,
          description: `Crie rifas online com PIX automático. Grátis para começar — comissão de ${taxaWooviLabel} sobre vendas, sem mensalidade.`,
        ...
        },
        {
          ...
          offers: {
            ...
            price: '0',
            priceCurrency: 'BRL',
            description: `Gratuito para criar conta. Comissão de ${taxaWooviLabel} sobre vendas`
          },
          featureList: [
            ...
            'Sem mensalidade',
            `Comissão ${taxaWooviLabel} no PIX`
          ]
        },
        faqJsonLd(faq)
      ]
...
function cadastroMeta(appUrl) {
  ...
  return {
    ...
    seoDescription: truncate(
      `Cadastre-se grátis e crie rifas online em minutos. PIX automático Woovi, comissão de ${taxaWooviLabel}. Comprador paga valor exato da cota.`
    ),
