...
function templateNovidadesPlataforma({ organizador, tenantSlug, rifasAtivas = [] }) {
  ...
  const conteudo = `
    <p style="margin:0 0 6px;font-size:22px;font-weight:800;color:#0f172a;">Novidades na sua loja ✨</p>
    <p style="margin:0 0 24px;font-size:15px;color:#475569;">
      Olá, ${nome}! Atualizamos a VouRifar para deixar suas rifas mais bonitas e fáceis de vender.
      Confira o que já está no ar:
    </p>
    ...
    ${caixaDestaque(`
      ...
      <ul style="margin:0;padding-left:20px;font-size:13px;color:#475569;line-height:1.85;">
        <li><strong style="color:#0f172a;">Tema claro na loja</strong> — visual branco por padrão; o comprador pode ativar o modo escuro no botão do menu</li>
        <li><strong style="color:#0f172a;">Galeria de fotos</strong> — várias imagens no carrossel da rifa</li>
        <li><strong style="color:#0f172a;">Pacotes rápidos e descontos</strong> — atalhos de quantidade e % off para vender mais cotas</li>
        <li><strong style="color:#0f172a;">Pódio 1º / 2º / 3º lugar</strong> — até três prêmios no mesmo sorteio</li>
        <li><strong style="color:#0f172a;">Carteira e saque</strong> — saldo e PIX Out mais estáveis via plataforma</li>
      </ul>
    `)}

    ${caixaDestaque(`
      <p style="margin:0;font-size:14px;color:#475569;line-height:1.7;">
        Vale abrir sua loja no celular e no computador para ver o visual novo —
        e, se quiser, editar a rifa para adicionar fotos, pacotes ou o pódio de prêmios.
      </p>
      ${listaRifas}
    `, '#eff6ff', '#3b82f6')}

    ${btnVerde('Abrir meu painel', adminUrl)}

    <p style="font-size:13px;color:#64748b;text-align:center;margin:0;">
      Ou veja como o público enxerga: <a href="${lojaUrl}" style="color:#10b981;font-weight:700;text-decoration:none;">${lojaUrl}</a>
    </p>
  `;

  return baseLayout({
    titulo: 'Novidades VouRifar',
    conteudo,
    rodapeExtra: 'Equipe VouRifar — qualquer dúvida, responda este e-mail.'
  });
}
