 ...
 * Alinhada a 5% (mesmo nível do MP) após desativação temporária do Mercado Pago.
 */
const TAXA_PLATAFORMA_WOOVI = 0.05; // 5% total retido

/** Percentual líquido que o organizador recebe por cota vendida (modalidade Plataforma) */
const ORGANIZADOR_PERCENTUAL_WOOVI = 1 - TAXA_PLATAFORMA_WOOVI; // 0.95

/**
 * Taxa fixa adicional cobrada por cota vendida na modalidade Plataforma (Woovi).
 * O comprador paga o valor exato da cota — o valor é descontado da parte do organizador.
 * Ex.: cota de R$ 10,00 → organizador recebe 10*0,95 - 0,50 = R$ 9,00.
 */
...
/** Taxa fixa cobrada em todo saque, independente do valor (debitada antes do PIX Out) */
